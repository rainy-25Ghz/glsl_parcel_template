...
function createTextureAndFramebuffer(
...
function main() {
    ...
    const programPostProcessingInfo =
        twgl.createProgramInfo(gl, [vs, fs_gamma]);
    ...
    function render(time: number) {
        ...
        const { texture, fb } = createTextureAndFramebuffer(
            gl,
            gl.canvas.width,
            gl.canvas.height
        );
